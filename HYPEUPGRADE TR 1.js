...
// ║ creators  : HYPEUPGRADETR , mrsebqstianc, spaceman, glaz, travelling_trader  ║
// ║                                                                              ║
// ║                                                                              ║
...
indicator(title='HYPEUPGRADETR 1', overlay=true, max_lines_count=500, max_boxes_count=500)
...
s3 = input.string(title='MA Type 3', defval='SMA', options=['na', 'SMA', 'EMA', 'WMA', 'RMA'])
len3 = input.int(20, minval=1, title='Length 3')
res3 = input.timeframe(title='Resolution 3', defval='D')
src3 = input(close, title='Source 3')
s4 = input.string(title='MA Type4', defval='SMA', options=['na', 'SMA', 'EMA', 'WMA', 'RMA'])
...
len5 = input.int(200, minval=2, title='Length 5')
...
plot(a5, color=color.new(#000000, 0))
